      ...
      <main>
        ...
        <section className="banner">
          <div className="banner-info">
            ...
            <p>
              Aprovecha descuentos por tiempo limitado en tortas y postres
              seleccionados. ¡Corre que se acaban!
            </p>
            <div className="banner-buttons">
              <Link to="/ofertas" className="btn-principal">🔥 Ver ofertas</Link>
            </div>
          </div>
          <div className="banner-img">
            <img
              src="img/Pastel_6.png"
