...
// Importar la lógica pura desde el archivo separado
const loadAdminUsuariosLogic = () => {
  const script = document.createElement('script');
  script.src = '/src/utils/Admin-Usuarios.logic.js';
  script.async = false;
  document.head.appendChild(script);
};

// Cargar el script de lógica si no está disponible
if (typeof window !== 'undefined' && !window.AdminUsuariosLogic) {
  loadAdminUsuariosLogic();
}

// Usar la función desde la lógica externa o fallback local
const fmtDate = (iso) => {
